...
<html>
    ...
    <!-- Mirrored from demo.bootstrapious.com/admin/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Aug 2017 01:50:38 GMT -->
    <head>
        <meta charset="utf-8">
                        ...
                        <div class="col-lg-6">
                            <div class="info d-flex align-items-center">
                                <div class="content">
                                    ...
                                    <p>Creditos online y confiable</p>
                                </div>
                            </div>
                        </div>
                        <!-- Form Panel    -->
                            ...
                            <div class="form d-flex align-items-center">
                                <div class="content">
                                    <form id="login-form" method="post">
                                        ...
                                        </div><a id="login" href="index-2.html" class="btn btn-primary">Login</a>
    ...
    <!-- Mirrored from demo.bootstrapious.com/admin/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Aug 2017 01:50:39 GMT -->
</html>