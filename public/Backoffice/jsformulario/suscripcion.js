...
$(".crud-submit").click(function (e) {
    ...
    var idPlan = $("#create-item").find("select[name='plan']").val();
    $.ajax({
        dataType: 'json',
        type: 'POST',
        url: form_action,
        data: {nombre: nombre,idPlan:idPlan}
    }).done(function (data) {
...
function mostrardata(data) {
    debugger;
    var route = "/Suscripcion/" + data;
    $("#edit-item").find("form").attr("action", url + '/' + data);
    $.get(route, function (res) {
        $(res).each(function (key, value) {
            $("#edit-item").find("input[name='nombre']").val(value.nombre);
            $("#edit-item").find("select[name='plan']").val(value.idPlan);
            document.getElementsByName("plan").value=value.idPlan;
        });
    });
...
$(".crud-submit-edit").click(function (e) {
    ...
    var idPlan = $("#edit-item").find("select[name='plan']").val();
    $.ajax({
        dataType: 'json',
        type: 'PUT',
        url: form_action,
